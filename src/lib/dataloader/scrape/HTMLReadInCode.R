##This code was used to scrape from basketball-reference.com during the 2015-2016 season.
##It would need to be heavily modified to work with current data.
...
Carmelo.Anthony.All <- PlayerStats(player='anthoca01', name='CARMELO.ANTHONY')
